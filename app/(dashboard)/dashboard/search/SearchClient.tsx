  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-10">
        ...
        <p className="text-sm text-gray-400">Find conversations for this tenant by phone number.</p>
      </div>
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="min-w-0 pr-3">
                  ...
                  <span
                    className="mt-1 inline-flex px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider"
